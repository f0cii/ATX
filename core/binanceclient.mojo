...
struct BinanceClient:
    ...
    fn public_time(self) raises -> Int:
        ...
        var server_time = doc.get_i64("serverTime")
        if server_time == 0:
    ...
    fn place_order(
        ...
        var _order_id = int(doc.get_i64("orderId"))
    ...
    fn do_post(
        ...
        if sign:
            ...
            return self.client.post(path, payload=body_, headers=headers)
        else:
            return self.client.post(path, payload=body, headers=headers)
    ...
    fn do_put(
        ...
        if sign:
            ...
            # logi("body_=" + body_)
            # return HttpResponse(200, "")
            return self.client.put(path, payload=body_, headers=headers)
        else:
            return self.client.put(path, payload=body, headers=headers)
