...
struct GateIOClient:
    ...
    #         var open_ = float(i_arr_list.at_str(1))
    #         var high = float(i_arr_list.at_str(2))
    #         var low = float(i_arr_list.at_str(3))
    #         var close = float(i_arr_list.at_str(4))
    #         var volume = float(i_arr_list.at_str(5))
    #         var turnover = float(i_arr_list.at_str(6))
    ...
    #         var price = float(i["price"].str())
    #         var qty = float(i["qty"].str())
    #         var cum_exec_qty = float(i["cumExecQty"].str())
    #         var order_status = i["orderStatus"].str()
    #         var created_time = i["createdTime"].str()
    #         var updated_time = i["updatedTime"].str()
    #         var avg_price = float(i["avgPrice"].str())
    #         var cum_exec_fee = float(i["cumExecFee"].str())
