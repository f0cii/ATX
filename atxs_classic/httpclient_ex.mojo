...
struct HttpClientOperation[origin: MutableOrigin]:
    var _op: c_void_ptr
    var _client: Pointer[HttpClientEx, origin]
    ...
    @always_inline
    fn call(self) -> Int:
        return int(photon_net_http_client_operation_call(self._op))

    @always_inline
    fn status_code(self) -> Int:
        return int(photon_net_http_client_operation_status_code(self._op))
