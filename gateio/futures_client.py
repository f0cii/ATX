...
from .base_client import GateIoBaseClient
from .constants import *


class FutureClient(GateIoBaseClient):
    def __init__(
        self, apikey="", apisecret="", use_server_time=False, domain=API_URL, proxy=None
    ):
        GateIoBaseClient.__init__(
            self, apikey, apisecret, use_server_time, domain, proxy
        )
    ...
    async def get_contracts(self, settle: str, limit: int = None, offset: int = None):
        ...
        success, error = await self._request(
            "GET", url, params=params, is_auth_required=False
        )
    ...
    async def get_trades(
        ...
        params = {"contract": contract, "offset": offset}
        if limit != 0:
            params["limit"] = limit
        if from_time != 0:
    ...
    async def get_premium_index_candlesticks(
        self,
        settle: str,
        contract: str,
        from_time: int = None,
    ...
    async def get_positions(
        self, settle: str, holding: bool = None, limit: int = None, offset: int = None
    ):
        params = {}
    ...
    async def update_position_margin(self, settle: str, contract: str, change: str):
        ...
        success, error = await self._request(
            "POST", url, params=params, is_auth_required=True
        )
        return success, error
    ...
    # 更新仓位风险限额
    async def update_position_risk_limit(
        self, settle: str, contract: str, risk_limit: str = None
    ):
    ...
    # 更新双仓模式下的保证金
    async def update_dual_position_margin(
        self, settle: str, contract: str, change: str, dual_side: str
    ):
    ...
    # 更新双仓模式下的杠杆
    async def update_dual_position_leverage(
        self,
        settle: str,
        contract: str,
        leverage: str,
    ...
    # 更新双仓模式下的风险限额
    async def update_dual_position_risk_limit(
        self, settle: str, contract: str, risk_limit: str
    ):
    ...
    # 查询合约订单列表(时间区间)
    async def get_orders_in_time_range(
        self,
        settle: str,
        contract: str = None,
    ...
    async def place_batch_orders(
        self, settle: str, futuresorders: List[Dict[str, Any]]
    ):
    ...
    async def modify_order(
        ...
        success, error = await self._request(
            "PUT", url, data=body, is_auth_required=True
        )
        return success, error

    # 查询个人成交记录
    async def get_personal_trades(
        self,
        settle: str,
    ...
    # 查询个人成交记录(时间区间)
    async def get_personal_trades_timerange(
        self,
        settle: str,
    ...
    # 查询平仓历史
    async def get_position_close_history(
        self,
        settle: str,
        contract: Optional[str] = None,
        limit: Optional[int] = None,
    ...
    # 查询ADL自动减仓订单信息
    async def get_auto_deleverage_orders(
        self,
        settle: str,
        contract: Optional[str] = None,
        limit: Optional[int] = None,
    ...
    # 倒计时取消订单
    async def set_countdown_cancel_all(
        self, settle: str, timeout: int, contract: Optional[str] = None
    ):
    ...
    # 创建价格触发订单
    async def create_price_trigger_order(
        self, settle: str, FuturesPriceTriggeredOrder: Dict[str, Any]
    ):
    ...
    # 查询自动订单列表
    async def get_price_trigger_orders(
        self,
        settle: str,
        status: str,
        contract: str = None,
