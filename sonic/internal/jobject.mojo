...
alias fn_jobject_get_bool = fn (self: UnsafePointer[JObject], key: DiplomatStringView) -> OptionBoolResult
...
alias fn_jobject_get_str_ref = fn (self: UnsafePointer[JObject], key: DiplomatStringView) -> DiplomatStringView
...
@always_inline
fn jobject_get_bool(self: UnsafePointer[JObject], key: DiplomatStringView) -> OptionBoolResult:
    return __wrapper._jobject_get_bool(self, key)
...
@always_inline
fn jobject_get_str_ref(self: UnsafePointer[JObject], key: DiplomatStringView) -> DiplomatStringView:
    return __wrapper._jobject_get_str_ref(self, key)
